...
/**
 * Vaadin configuration dialog for uv-dpu-l-attx-uploader.
 *
 * @author ATTX
 */
public class UploaderVaadinDialog extends AbstractDialog<UploaderConfig_V1> {
   ...
   private ObjectProperty<String> endpointURL = new ObjectProperty<String>("");
    ...
    public UploaderVaadinDialog() {
        super(Uploader.class);
    }
    ...
    @Override
    protected UploaderConfig_V1 getConfiguration() throws DPUConfigException {
        UploaderConfig_V1 result = new UploaderConfig_V1();
    ...
    @Override
    protected void setConfiguration(UploaderConfig_V1 config) throws DPUConfigException {
